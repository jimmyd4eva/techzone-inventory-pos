...
import { DollarSign, Package, Wrench, Users, Crown, Ticket, AlertTriangle, PackageX, Mail, Download, MessageCircle, TrendingDown, Tag } from 'lucide-react';
...
const Dashboard = () => {
  ...
  useEffect(() => {
    Promise.all([fetchStats(), fetchTopCustomers(), fetchLostCustomers(), fetchLowStock(), fetchSlowMoving()])
