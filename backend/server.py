...
@api_router.post("/cash-register/transaction")
...
@api_router.get("/cash-register/shift/{shift_id}")
...
@api_router.get("/cash-register/daily-summary")
...
@api_router.get("/cash-register/report/{shift_id}")
...
if osp.exists(_frontend_build) and osp.exists(osp.join(_frontend_build, "static")):
    ...
    app.mount("/static", StaticFiles(directory=osp.join(_frontend_build, "static")), name="frontend_static")
