# -*- coding: utf-8 -*-
"""
TechZone POS - COMPLETE Data Import Script
==========================================
This script imports ALL data from production to your local MongoDB.

Instructions:
1. Make sure MongoDB is running (mongod)
2. Run: python IMPORT_ALL_DATA.py
...
def import_data():
    print("=" * 50)
    print("TechZone POS - Complete Data Import")
    print("=" * 50)
    print()
    ...
    for collection_name, documents in data_map.items():
        if documents:
            ...
            if documents:
                ...
                print(f"[OK] Imported {len(documents):>3} records into {collection_name}")
    
    # Clear activation data for fresh start
